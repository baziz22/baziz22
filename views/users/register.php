                ...
                <!-- <form action="register/register_run" method="POST"> -->
                    ...
                    <div class="register-box">
                        <span class="error-message not-success">
                            <?php  if(isset($_GET['register_user_name_error'])){
                                echo $_GET['register_user_name_error'];
                            } ?>
                        </span>
                        ...
                        <input type="text" placeholder="Username *" class="input register-input register-user-name" name="register-user-name" id="register-user-name" value="<?php if(isset($_GET['register_user_name'])){
                            echo $_GET['register_user_name'];
                        } ?>"/>
                    </div>
                    <!-- email input -->
                    <div class="register-box">
                        <span class="error-message not-success">
                            <?php  if(isset($_GET['register_email_error'])){
                                echo $_GET['register_email_error'];
                            } ?>
                        </span>
                        ...
                        <i class="fa-regular fa-circle-xmark"></i> -->
                        <small></small>
                        <input type="text" placeholder="Email *" class="input register-input register-email" name="register-email" id="register-email" value="<?php if(isset($_GET['register_email'])){
                    ...
                    <div class="register-box">
                        ...
                        <span class="error-message not-success">
                        <?php  
                            if(isset($_GET['register_password_error'])){
                                echo $_GET['register_password_error'];
                            } ?>
                        </span>
                        <!-- <span class="fas fa-lock"></span> -->
                    ...
                    <div class="register-box">
                        ...
                        <span class="error-message not-success">
                            <?php 
                            if(isset($_GET['register_password_confirm_error'])){
                                echo $_GET['register_password_confirm_error'];
                            } ?>
                        </span>
                        <!-- <span class="fas fa-lock"></span> -->
                        <!-- <label class="label" for="register-phone"><span class="asterisk-required"></span></label> -->
