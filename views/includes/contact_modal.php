...
<?php 
  ...
  $where_at = isset($_GET['url']) ? $_GET['url'] : 'index' ; 
    ...
    <div class="form-group">
      ...
      <!-- <form action="" method="POST" id="contact-form" name="contact-form" enctype="text/plain"> -->
        ...
        <div class="contact-box">
          ...
          <i class="fa-regular fa-circle-xmark"></i>
          <small></small>
          <textarea class="contact-input contact-text-area" name="contact-message" cols="40" rows="4" placeholder="Please include your phone number" id="contact-message"><?php echo isset($fields['contact-message']) ? test_input($fields['contact-message']) : ""; ?></textarea>
        </div>
