...
function escape_injection($data){
    // htmlentities would be converted "less than and greater than signs of javascript tags" and render it as ASCII, ex-> &lt and &gt. so it would be leave it rendered in page rather than actually executed once you implement it.
    //ENT_QUOTES: Will convert single and double quotes to ascii as well.
    // UTF-8: Provide character encoding
    // fales: You need to pass in false.
