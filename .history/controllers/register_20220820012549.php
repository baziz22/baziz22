    ...
    if($register_user_name_error == '' && $register_email_error == '' && $register_password_error == '' && $register_password_confirm_error == ''){
        ...
        if(!$looks_good){
            ...
            if($message_warning == '' && $register_user_name_error == '' && $register_email_error == ''){
                $message_success = 'Looks Good!';
                header("Location: ../register?message_warning=$message_warning&wrong=1");
            } else {
                header("Location: ../register?register_user_name_error=$register_user_name_error&register_email_error=$register_email_error&message_warning=$message_warning&register_user_name=$register_user_name&register_email=$register_email&wrong=1");
            }
            
            
        } else {
            $message_warning  .= $looks_good . "is True!";
            $looks_good = true;
        } 
        function bader() {
