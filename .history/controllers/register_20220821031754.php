    ...
    public function register_run(){
        ...
        if($message_warning == '' && $register_user_name_error == '' && $register_email_error == ''){
            if(isValidPassword($register_password) == '' && $register_password == $register_password_confirm) {
                ...
                //$singleton = Register::register_run();
                register_user_last_step($register_user_name, $register_email,$hashing);
            }
        } else {
        ...
        function register_user_last_step($register_user_name, $register_email,$hashing){
            // Talk to the register_model
                    //$singleton = Register::register_run();
                    $b = new Controller->loadModel('register');
