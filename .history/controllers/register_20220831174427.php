...
class Register extends Controller{
    ...
    public function register_run(){
        ...
        echo "message_warning:", $message_warning.BR;
        
        echo "register_user_name_error: ", $register_user_name_error.BR;
        echo "register_email_error: ",  $register_email_error.BR;
        echo "register_password_error: ", $register_password_error.BR;
        echo "register_password_confirm_error: ", $register_password_confirm_error.BR;
        ...
        if($message_warning == '' && $register_user_name_error == '' && $register_email_error == ''){
            if(isValidPassword($register_password) == '' && $register_password == $register_password_confirm) {
                ...
                //$singleton = Controller::loadModel('register');
                $this->model->register_user($register_user_name, $register_email,$hashing);
            }
        } else {
    ...
    public function singleUserByUsername($username) {
        $sql = "SELECT user_id, user_name, user_status FROM users WHERE user_name = :username";
        ...
        header("Location: " . URLROOT . "../user?user_id=$user_id&user_name=$user_name");
        return $data;
    }
