    ...
    if($register_user_name_error == '' && $register_email_error == '' && $register_password_error == '' && $register_password_confirm_error == ''){
        ...
        if(!$looks_good){
            ...
            if (empty($register_user_name)){
                ...
                $message_warning .= "Username is REQUIRED!";
                ...
                $register_email_error = "Email is REQUIRED!".BR;
                $message_warning .= "Email is REQUIRED!
            }else {
                $looks_good = true;
            } 
        }
        header("Location: ../register?register_user_name_error=$register_user_name_error&message_warning=$message_warning&register_user_name=$register_user_name&wrong=1");
