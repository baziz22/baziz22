...
if (isset($_POST['register-submit-btn'])){
    ...
    if($register_user_name_error == '' && $register_email_error == '' && $register_password_error == '' && $register_password_confirm_error == ''){
        ...
        header("Location: ../register?register_user_name_error=$register_user_name_error&register_email_error&message_warning=$message_warning&register_user_name=$register_user_name&wrong=1");
