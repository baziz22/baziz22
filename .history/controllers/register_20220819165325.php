...
class Register extends Controller{
    ...
    public function register_user($username, $email, $password){
        ...
        $email = filter_input(INPUT_POST, 'username', FILTER_DEFAULT);
        $password = filter_input(INPUT_POST, 'username', FILTER_DEFAULT);
        $this->loadModel('register');
        $this->model->check_login_username($username, $email, $password); 
    }
}
