    ...
    <div class="project-live-modal-content">
      ...
      <div class="project-live-modal-body">
        <div class="svg-container">
          <div class="show-project" id="project-active" style="display:hidden;">
            <script type="text/javascript" src="<?php URLROOT; ?>views/includes/project_live/bar_chart/js/jp.js">
            </script>
          </div>
