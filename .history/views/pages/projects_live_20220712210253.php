...
<section class="glass first_page_scroll first_line_page" class="section-two first_line_page">
<main class="section-main first_line_page"">
...
<div id="about-website">
    ...
    <div id="projects-live-container" class="projects-live-container" class="first_page_scroll"></div>
<!-- The Modal -->
