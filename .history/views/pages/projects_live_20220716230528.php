    ...
    <div class="project-live-modal-content">
      ...
      <div class="project-live-modal-body">
        <div class="svg-container">
          <div class="show-project" id="project-active"></div>
          <script class="show-project" id="project-active" type="text/javascript" src="<?php URLROOT; ?>views/includes/project_live/bar_chart/js/jp.js">

          </script>
        <script class="show-project" type="text/javascript" src="<?php URLROOT; ?>views/includes/project_live/bar_chart/js/barchart_scale_axis.js"></script>
