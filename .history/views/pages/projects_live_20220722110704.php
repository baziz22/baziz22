...
<script>
  ...
  const change_font_size = document.getElementById("coming-soon")
  function comingSoon() {
    console.log("clickedded@1: " );
    change_size.style.fontSize = "xx-large";
  }

  document.getElementById("coming-soon").addEventListener("click", myScript);
</script>
