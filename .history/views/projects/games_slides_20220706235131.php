    ...
    <div class="card-info">
        ...
        <div class="mySlides fade">
            ...
            <img src="<?php URLROOT; ?>public/images/slides/guessNumber.png" a width="600px" height="400px" alt="" style="width:100%">
            <div class="text">Guess Number</div>
        </div>

        <div class="mySlides fade">
            <div class="numbertext">3</div>
            <img src="<?php URLROOT; ?>public/images/slides/snake.png" width="600px" height="400px" alt="" style="width:100%">
            <div class="text">Snake</div>
        </div>
        <div class="mySlides fade">
            <div class="numbertext">4</div>
            <img src="<?php URLROOT; ?>public/images/slides/spaceInvaderPoster.jpg" alt="" /> width="600px" height="400px" alt="" style="width:100%">
