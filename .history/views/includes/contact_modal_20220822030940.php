    ...
    <div class="form-group">
      ...
      <?php if(!empty($errors)) : ?>
        <div class="panel contact-full-name">
          <ul>
            <li><?php explode('<li></li>', $errors);?></li>
          </ul>
        </div>
      <?php endif; ?>
      ...
      <!-- <form action="" method="POST" enctype="text/plain"> -->
        ...
        <div class="contact-box">
          <input type="hidden" class="contact-hidden-input" />
        </div>
        ...
        <div class="contact-box">
          ...
          <small></small>
          <input type="text" class="contact-input contact-full-name"" name=" contact-full-name" id="contact-full-name" value="<?php echo isset($fields['contact-full-name']) ? test_input($field['contact-full-name']) : ""; ?>" />
        </div>
        ...
        <div class="contact-box">
          ...
          <i class="fa-regular fa-circle-xmark"></i>
          <small></small>
          <textarea class="contact-input contact-text-area" name="contact-message" cols="40" rows="4" id="contact-message"><?php echo isset($fields['contact-full-name']) ? test_input($field['contact-full-name']) : ""; ?></textarea>
        </div>
