...
function isValidPassword($check_password){
    ...
    if (empty($register_user_name)){
        ...
        if(!preg_match("/^[a-zA-Z0-9._]*$/",        $register_user_name)){
            ...
            $message_warning  .= "OLetters, Numbers, - , . , Only allowed".BR; 
        }
    }
    ...
    $register_user_name_error == '' && $register_email_error == '' && $register_password_matched_number_error == '' && $register_url_error == ''){
