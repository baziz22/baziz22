    ...
    <div class="form-group">
      ...
      <!-- <form action="" method="POST" enctype="text/plain"> -->
        ...
        <div class="contact-box">
          ...
          <i class="fa-regular fa-circle-xmark"></i>
          <small></small>
          <textarea class="contact-input contact-text-area" name="contact-message" cols="40" rows="4" id="contact-message"><?php echo isset($fields['contact-message']) ? test_input($field['contact-full-name']) : ""; ?></textarea>
        </div>
