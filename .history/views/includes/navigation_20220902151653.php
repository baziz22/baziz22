    ...
    <div class="nav_link">
        ...
        <?php if (Session::get('loggedIn') == false) : ?>
            ...
            <?php if (Session::get('loggedIn') == true) : ?>
                ...
                <?php endif; ?>
                <li class="btn-login"><a href="logout" class="login-button login_btn_created"><button class='btn'>Logout</button></a></li><?php 
                  
                  echo (Session::get('username') == $_SESSION['username']) ? "Welcome " . $_SESSION['user_name'] : '';
                  ?>
            <?php else : ?>
