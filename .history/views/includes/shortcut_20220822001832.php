...
function escape_injection($data){
    // htmlentities will render "less than and greater than signs of javascript tags" to ASCII. It would be converted to  rather that executed once you implement it.
