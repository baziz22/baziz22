<section class="dashboard-container">
      ...
      <div class="dashboard-main">
        ...
        <div class="dashboard-main-upper-middle">
          <div class="dashboard-statistics">
            statistics<br>
            <img class="dashboard-statistics-chart" src="<?php URLROOT; ?>public/images/line-graph.png" alt="">
          </div>
          <div class="dashboard-extra-statistics">
            More Statistics<br>
            <img class="dashboard-statistics-chart" src="./asset/images/pie-chart.png" alt="">
          </div>
        </div>
        <div class="dashboard-main-lower-middle">
          <p>Item Management</p>
          <img class="dashboard-main-lower-middle-picture" src="./asset/images/crud_list.png" alt="">
        </div>
      ...
      <div class="dashboard-profile">
        <div>
          <img  class="dashboard-profile-picture" src="./asset/images/memoji-profile-picture.jpeg" alt="" />
        </div>
