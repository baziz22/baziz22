...
function escape_injection($data){
    // htmlentities would be converted towill render "less than and greater than signs of javascript tags" to ASCII. It   rather that executed once you implement it.
