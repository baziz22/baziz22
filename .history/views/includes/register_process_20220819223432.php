...
if (isset($_POST['register-submit-btn'])){
    ...
    if($register_user_name_error == '' && $register_email_error == '' && $register_password_error == '' && $register_password_confirm_error == ''){
        $register_successful = true;$message_success = 'Every Thing Looks Good!' .BR . 'You have been REGISTERED successfully.' .BR . 'Please Check Your Email to activate your account.';
