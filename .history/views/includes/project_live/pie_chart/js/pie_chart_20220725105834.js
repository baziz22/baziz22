...
let pie_chart_csv_pie = d3.pie().padAngle(0.01).value(function (d) {
  return d.population;
}).sort(null);
...
let pie_chart_csv_label = d3
  .arc()
  .outerRadius(pie_chart_csv_radius * 0.50)
  .innerRadius(pie_chart_csv_radius * 0.9);
...
.text(function(d) { 
  ...
  pie_chart_csv_arc
    ...
    .attr("transform", function (d) {
      ...
      console.log("centroid: ",pie_chart_csv_label.centroid(d));
      return "translate(" + pie_chart_csv_label.centroid(d) + ")";
