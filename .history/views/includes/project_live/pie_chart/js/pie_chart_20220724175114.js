...
.attr("width", 25)
.attr("height", 20)
.style("fill", function(d) { return pie_chart_csv_color(d.data.browser); });
...
.text(function(d) { 
    if (d.percent != 0) { return d.data.browser + " (" + d.data.percent + ")" } 
        else return d.browser
});;
...
// print the total number of p in the pie center
pie_chart_csv_svg.append("g")
.attr("dy", ".70em")
