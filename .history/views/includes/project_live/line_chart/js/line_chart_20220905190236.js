function load_contents(){
  ...
  let dataset;
  let line_Color = d3.interpolateInferno(0.45);
  ...
  function createBarChart(){
    ...
    line_chartXscale.domain(dataset.map((data) => data.year));
          ...
          function barMouseOver(event, d){
              ...
              .attr("stroke-width", 3)
              .attr("opacity",0.5)
              .attr('width', line_chartXscale.bandwidth() + 5)    
          ...
          const yGridlines = d3.axisLeft()
              .scale(line_chartYscale)
              .ticks(5)
              .tickSize(-line_chart_scale_axis_width+120,0,0)
              .tickFormat('')
  
              g_main_line_chart.append('g')
              .call(yGridlines)
