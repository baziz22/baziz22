    const world_map_scale_axises_width = 600;
    const world_map_scale_axises_height = 500;

    const world_map_svg = d3.select('.svg-container').append('svg')
    .attr("viewBox", "0 0 "+world_map_scale_axises_width+" "+world_map_scale_axises_height)
        .classed("svg-content", true)
        .style("font-family", "Bradley Hand,  Arial, Helvetica, sans-serif")
    /* .attr('width', world_map_scale_axises_width)
    .attr('height', world_map_scale_axises_height); */
    ...
    .attr("transform", "translate(" + -(world_map_scale_axises_width/3.3) + "," + world_map_scale_axises_height*0 + ")");
    ...
    g_main_world_map.append('path')
            .attr('class', 'sphere')
            .attr('d', world_map_pathGenerator({type: 'Sphere'}));
    ...
    g_main_world_map.append("text")
            ...
            .text("Design and Programmed by Bader Binsunbil Version 1.0.0 bbins.me");