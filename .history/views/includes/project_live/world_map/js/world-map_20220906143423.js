    ...
    const world_map_svg = d3.select('body').append('svg').attr('width', world_map_scale_axises_width).attr('height', world_map_scale_axises_height);
    ...
    const g_main_world_map_ = world_map_svg.append('g');
