...
function escape_injection($data){
    // htmlentities would be converted "less than and greater than signs of javascript tags" and render it as ASCII, ex-> &lt oan &gt. so it   wourather that executed once you implement it.
