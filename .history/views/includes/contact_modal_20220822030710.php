    ...
    <div class="form-group">
      ...
      <!-- <form action="" method="POST" enctype="text/plain"> -->
        ...
        <div class="contact-box">
          ...
          <small></small>
          <input type="text" class="contact-input contact-full-name"" name=" contact-full-name" id="contact-full-name" <?php echo isset($fields['contact-full-name']) ? test_input($field['contact-full-name'] : ""; ?> />
        </div>
