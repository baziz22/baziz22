...
function escape_injection($data){
    // htmlentities would be converted "less than and greater than signs of javascript tags" and render it as ASCII, ex-> &lt oan &gt. so it   would be rendered in page rather that executed once you implement it.
