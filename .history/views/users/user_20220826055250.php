          ...
          <div class="dashboard-main-upper-middle">
            ...
            <div class="dashboard-statistics">
              ...
              <div class="dashboard-edit-user">
                <h2>Edit User</h2>
                <?php
                print_r($this->editSave->singleUser);
                //echo 'The id is: '.$this->edit()->singleUser['user_id'];
                ?>
                <form action="../editSave/<?php echo $this->userList['user_id']; ?>" method="POST">
                  <label for=""></label><input type="text" name="username" placeholder="username" value="<?php echo $this->user['username']; ?>"><br />
                  ...
                  <label for="">&nbsp;</label><input type="submit" name="submit">
                </form>
              </div>
            </div>
