        ...
        <div class="user-list-table">
            ...
            <?php
                ...
                foreach ($this->userList as $key => $value) {
                    ...
                    echo '</tr>'; */
                    echo '<td> <a href="#"><button class="btn btn-view"><i class="fa-solid fa-trash-can"></i>View</button></a>
                    <a href="' . URLROOT .'user/edit/'. $value['user_id'] . '"><button class="btn btn-edit">Edit</button></a>
                    <a href="' . URLROOT .'user/delete/'. $value['user_id'] . '"><button class="btn btn-delete">Delete</button></a>
                    </td>';
                }
            ?>
            </table>
