                ...
                <div class="dashboard-statistics">
                    ...
                    <div class="dashboard-edit-user">
                        ...
                        <form action="../editSave/<?php echo $this->user['user_id']; ?>" method="POST">
                            <h1>Edit User:</h1>
                            <label for=""></label><input type="text" placeholder="username" name="username" value="<?php echo $this->user['user_name']; ?>"><br />
                            <label for="">Password: </label><input type="text" name="password" placeholder="Password" ><br />
                    ...
                    <div class="user-list-table">
                        ...
                        //print_r($this->user);
                            ...
                            foreach ($this->userList as $key => $value) {
                                ...
                                <a href="' . URLROOT .'user/edit/'. $value['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-pencil"></i> Edit</button></a>
