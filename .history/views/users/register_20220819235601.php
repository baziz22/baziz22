            ...
            <div class="wrapper-login">
                ...
                <!-- <form action="register/register_run" method="POST"> -->
                    ...
                    <div class="register-box">
                        ...
                        <input type="text" placeholder="Username *" class="input register-input register-user-name" name="register-user-name" id="register-user-name" value="<?phpif echo if_isset($register_user_name) ?>"/>
                    </div>
                    <!-- email input -->
                    <div class="register-box">
                        <span class="error-message not-success">
