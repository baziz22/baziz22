...
<form action="../editSave/<?php echo $this->user['user_id']; ?>" method="POST">
    <label for="">Usernamey: </label><input type="text" name="username" value="<?php echo $this->user['user_name']; ?>"><br />
    ...
    <select name="the_role" id="">
        ...
        <option value="super" <?php if($this->user['user_role'] == 'user') echo 'selected'; ?>>Super</option>
        <option value="admin" <?php if($this->user['user_role'] == 'admin') echo 'selected'; ?>>Admin</option>
        <!-- <option value="owner" <?php if($this->user['user_role'] == 'admin') echo 'selected'; ?>>Owner</option> -->
    </select><br />
