              ...
              <table>
                ...
                //foreach ($this->model->db->pagination($start_from, $per_page_record) as $key => $value) {
                  ...
                  <tr>
                    ...
                    <td><a href="<?php URLROOT . 'user/activate_user/' . $value['user_id'] ?>"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a></td>
                    <td><?php if($value['user_status'] == 1){echo '<button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button>';}else{echo "Notheing!";} ?><a href="<?php URLROOT . 'user/activate_user/' . $value['user_id'] .'"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a></td>
                    <td><a href="<?php URLROOT . 'user/delete/' . $value['user_id'] ?>"><button class="btn btn-delete"><i class="fa-solid fa-trash-can"></i>Delete</button></a></td>
                    <td></td>
                  </tr>
