    ...
    <div id="first_line_page">
      <section class="dashboard-container">
        ...
        <div class="dashboard-main">
          ...
          <div class="dashboard-main-lower-middle">
            ...
            <div class="user-list-table">
              <table>
                ...
                <?php $total_records = $this->total_records;
                echo "</br>";
          ...
          if ($page >= 2) {
            echo "<a href='pagination?page=" . ($page - 1) . "'>  Prev </a>";
          }

          for ($i = 1; $i <= $total_pages; $i++) {
            if ($i == $page) {
              $pagLink .= "<a class = 'active' href='pagination?page="
                . $i . "'>" . $i . " </a>";
            } else {
              $pagLink .= "<a href='pagination?page=" . $i . "'>   
                                                " . $i . " </a>";
            }
          };
          echo $pagLink;
          ...
          if ($page < $total_pages) {
            echo "<a href='pagination?page=" . ($page + 1) . "'>  Next </a>";
          }
