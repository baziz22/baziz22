      ...
      <section class="dashboard-container">
        ...
        <div class="dashboard-main">
          <div class="dashboard-main-top">Admin Dashboard</div>
            ...
            <?php
            $id = $_SESSION['user_id'];
            $logged_username = $_SESSION['user_username'];
            $userObj = new user();
            ...
            <div class="dashboard-search-user">
              ...
              <div id="search-results">
                <?php echo ((isset($_GET['user_name'])) ? $_GET['user_name'] : ($users_basic_details['user_name'])) ? $users_basic_details['user_name'] :'User not found'; ?>
              </div>
