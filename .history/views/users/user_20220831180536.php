        ...
        <div class="dashboard-main">
          ...
          <div class="dashboard-main-upper-middle">
            ...
            <div class="dashboard-statistics">
              ...
              // $single_user_record = $userObj->singleUserByUsername();
              ...
              <div class="dashboard-search-user">
                ...
                <div class="user-list-table">
                  ...
                  <div class="dashboard-table-header">
                    ...
                    <td class="action-btn"><?php (isset($_GET['user_status'])) ? ($single_user_record['user_status'] == 1) ?
                          echo '<button class="btn btn-status-inactive"><i class="fa-solid fa-trash-can"></i>activated</button>'; : echo '<a href="' . URLROOT . 'user/activate_user/' . $single_user_record['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a>'; : $_GET['user_name'];
                         ?></td>
