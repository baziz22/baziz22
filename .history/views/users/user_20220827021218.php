          ...
          <div class="dashboard-main-upper-middle">
            ...
            <div class="dashboard-statistics">
              ...
              <div class="dashboard-edit-user">
                ...
                ?>
                <form action="../editSave/<?php echo $singleser['user_id']; ?>" method="POST">
                  <label for=""></label><input type="text" name="username" placeholder="username" value="<?php echo $singleser['user_name']; ?>"><br />
                  <label for=""></label><input type="text" name="password" placeholder="Password"><br />
                  <label for=""></label>
                  <select name="the_role" id="">
                    <option value="default" <?php if ($singleser['user_role'] == 'default') echo 'selected'; ?>>Default</option>
                    <option value="user" <?php if ($this->singleser['user_role'] == 'user') echo 'selected'; ?>>User</option>
                    <option value="super" <?php if ($this->singleser['user_role'] == 'super') echo 'selected'; ?>>Super</option>
                    <option value="admin" <?php if ($this->singleser['user_role'] == 'admin') echo 'selected'; ?>>Admin</option>
                    <!-- <option value="owner" <?php if ($this->singleser['user_role'] == 'owner') echo 'selected'; ?>>Owner</option> -->
                  </select><br />
