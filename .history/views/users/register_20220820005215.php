            ...
            <div class="wrapper-login">
                ...
                <!-- <form action="register/register_run" method="POST"> -->
                    ...
                    <div class="register-box">
                        ...
                        <i class="fa-regular fa-circle-xmark"></i> -->
                        <small></small>
                        <input type="text" placeholder="Email *" class="input register-input register-email" name="register-email" id="register-email" value="<?php if(isset($_GET['register_user_name'])){
                            echo $_GET['register_user_name'];
                        } ?>" />
                    </div>
                    <!-- password input -->
