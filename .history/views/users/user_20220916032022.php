        ...
        <div class="dashboard-main">
          <div class="dashboard-main-top">Admin Dashboard</div>
            ...
            <div class="dashboard-search-user">
              ...
              <div id="search-results">
                <?php 
                if(isset($_GET['search-result']) && isset($_GET['wrong']) == 1):
                  echo 'User not found';
                elseif(isset($_GET['search-result']) && isset($_GET['wrong']) == 0):
                  echo $_GET['search-result'];
                  elseif(isset($_GET['user_id'])):
                    echo $_GET['user_name'];
                else : echo $logged_username;
                endif; 
                ?>
              </div>
              <div class="user-list-table">
                ...
                <!-- <div class="dashboard-table-header"> -->
                  ...
                  <tr class="table-data">
                    ...
                    <td class="action-btn"><?= ($single_user_record['user_status'] == 1) ? '<button class="btn btn-status-active"><i class="fa-solid fa-square-check"></i> activated</button>' : '<a href="' . URLROOT . 'user/activate_user/' . $single_user_record['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-power-off"></i> activate</button></a>' ;
                    ?>
                    </td>
          ...
          <div class="dashboard-main-lower-middle">
            ...
            <div class="pages-quick-access">
              ...
              <button onClick="go2Page();" class="btn dashboard-btn quick-navigate-button" style="display:inline-block">Go</button>
            </div>
...
<script>
  function go2Page() {
    ...
    window.location.href = 'user?page=' + page + '&id=' + id;
  }
</script>