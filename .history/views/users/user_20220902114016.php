            ...
            <div class="dashboard-search-user">
              ...
              <div class="user-list-table">
                ...
                <div class="dashboard-table-header">
                  ...
                  ?></td>
                  <td class="action-btn"><a href="<?php URLROOT . 'user/delete/' .  $single_user_record['user_id']; ?>"><button class="btn btn-delete"><i class="fa-solid fa-trash-can"></i>Delete</button></a></td>
                  </tr>
                </table>
              </div>
            </div>
