                ...
                <table>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="sender_email"><?= $value['sender_email'] ?></td>
                      <td><?= $value['sender_mobile'] ?></td>
                      <td class="message-comments"><?= $value['sender_comment'] ?></td>
                      <td><?= $value['added_on'] ?></td>
                      <td><a href="#"><button class="btn btn-view"><i class="fa-solid fa-magnifying-glass"></i>View</button></a></td>
                      <td><?php echo '<a href="' . URLROOT . 'message/archive/' . $value['sender_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>archive</button></a>';?></td>
                      <td><a href="<?php URLROOT . 'message/delete/' . $value['sender_id'] ?>"><button class="btn btn-delete"><i class="fa-solid fa-trash-can"></i>Delete</button></a></td>
                      <td></td>
                    </tr>
