            ...
            <div class="wrapper-login">
                ...
                <!-- <form action="register/register_run" method="POST"> -->
                    ...
                    <div class="register-box">
                        ...
                        <input type="text" placeholder="Username *" class="input register-input register-user-name" name="register-user-name" id="register-user-name" value="<?php if(isset($GET$register_user_name)){
