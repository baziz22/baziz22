              ...
              <table>
                ...
                //foreach ($this->model->db->pagination($start_from, $per_page_record) as $key => $value) {
                  ...
                  <tr>
                    ...
                    <td><?php if($value['user_status'] === 1){echo 8654;}else{echo} ?><a href="<?php URLROOT . 'user/activate_user/' . $value['user_id'] ?>"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a></td>
