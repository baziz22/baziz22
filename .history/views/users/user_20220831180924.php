                ...
                <div class="user-list-table">
                  ...
                  <div class="dashboard-table-header">
                    ...
                    <td class="action-btn"><?= (isset($_GET['user_status'])) ? echo ($_GET['user_status']['user_status'] == 1) ?
                           '<button class="btn btn-status-inactive"><i class="fa-solid fa-trash-can"></i>activated</button>'; : echo '<a href="' . URLROOT . 'user/activate_user/' . $_GET['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a>'; : $_GET['user_name'];
                         ?></td>
