          ...
          <div class="dashboard-main-upper-middle">
            ...
            <div class="dashboard-statistics">
              ...
              <div class="dashboard-search-user">
                ...
                <?php
                foreach ($users_basic_details as $value) {
                  (isset($_GET['search-result'])) ? $_GET['search-result'] : $id
                }
                ?>
                <form action="user/single_user/<?= (isset($_GET['search-result'])) ? $_GET['search-result'] : $id ?>" method="post">
                ...
                <div class="user-list-table">
                  ...
                  <div class="dashboard-table-header">
                    ...
                    <tr>
                    <td><?= $single_user_record['user_name'] ?></td>
                    <td class="action-btn"><a href="#"><button class="btn btn-view"><i class="fa-solid fa-magnifying-glass"></i>View</button></a></td>
                    <td class="action-btn"><?php if ($single_user_record['user_status'] == 1) {
                          echo '<button class="btn btn-status-inactive"><i class="fa-solid fa-trash-can"></i>activated</button>';
                        } else {
                          echo '<a href="' . URLROOT . 'user/activate_user/' . $single_user_record['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a>';
                        } ?></td>
