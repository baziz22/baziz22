        ...
        <div class="dashboard-main">
          ...
          <div class="dashboard-main-upper-middle">
            ...
            <div class="dashboard-statistics">
              ...
              $single_user_record = $userObj->all_records();
              $id = $_SESSION['user_id'];
              ...
              <table>
                <div class="dashboard-table-header">
                  ...
                  foreach ($users_basic_details as $key => $value):?>
                    ...
                    <tr>
                    <td><?= $value[$id]['user_name'] ?></td>
                    <td class="action-btn"><a href="#"><button class="btn btn-view"><i class="fa-solid fa-magnifying-glass"></i>View</button></a></td>
                    <td class="action-btn"><?php if ($value[$id]['user_status'] == 1) {
                          echo '<button class="btn btn-status-inactive"><i class="fa-solid fa-trash-can"></i>activated</button>';
                        } else {
                          echo '<a href="' . URLROOT . 'user/activate_user/' . $value[$id]['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a>';
                        } ?></td>
                    <td class="action-btn"><a href="<?php URLROOT . 'user/delete/' . $value[$id]['user_id'] ?>"><button class="btn btn-delete"><i class="fa-solid fa-trash-can"></i>Delete</button></a></td>
                  </tr>
                  <?php endforeach; ?>
              </table>
            </div>
