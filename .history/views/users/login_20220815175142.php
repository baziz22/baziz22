        ...
        <div id="first_line_page">
            ...
            <div class="wrapper-login">
                ...
                <form action="" method="POST">
                    ...
                    <input type="text" placeholder="Username *" name="username" id="login-username" value="<?php echo $inputs['username'] ?? '' ?>" class="<?php echo isset($errors['username']) ? 'invalidFeedback' : ''  ?>">
