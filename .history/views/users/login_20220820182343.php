        ...
        <div id="first_line_page">
            ...
            <div class="wrapper-login">
                ...
                <form action="login/login_run" method="POST">
                    ...
                    <input type="text" placeholder="Username *" name="login-user-name" id="login-user-name" value="<?php if (isset($_GET['username'])) echo $uname; ?>" id="<?php echo isset($errors['login-user-name']) ? 'invalidFeedback' : ''  ?>">
