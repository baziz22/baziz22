          ...
          <div class="dashboard-main-lower-middle">
            ...
            <?php
                ...
                <table>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="sender_email"><?= $value['email'] ?></td>
                      <td><?= $value['sender_mobile'] ?></td>
                      <td class="message-comments"><?= $value['cender_comment'] ?></td>
                      <td><?= $value['sender_added_on'] ?></td>
                      <td><a href="#"><button class="btn btn-view"><i class="fa-solid fa-magnifying-glass"></i>View</button></a></td>
                      <td><?php echo '<a href="' . URLROOT . 'message/archive/' . $value['id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>archive</button></a>';?></td>
                      <td><a href="<?php URLROOT . 'message/delete/' . $value['id'] ?>"><button class="btn btn-delete"><i class="fa-solid fa-trash-can"></i>Delete</button></a></td>
                      <td></td>
                    </tr>
              ...
              <div class="pagination">
                ...
                if ($page >= 2) {
                  echo "<a href='messages?page=" . ($page - 1) . "'> &laquo; Prev </a>";
                }

                for ($i = 1; $i <= $total_pages; $i++) {
                  if ($i == $page) {
                    $pagLink .= "<a class = 'active' href='messages?page="
                      . $i . "'>" . $i . " </a>";
                  } else {
                    $pagLink .= "<a href='messages?page=" . $i . "'>   
                                                  " . $i . " </a>";
                  }
                };
                echo $pagLink;
                ...
                if ($page < $total_pages) {
                  echo "<a href='v?page=" . ($page + 1) . "'>  Next &raquo;</a>";
                }
