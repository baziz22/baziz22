        ...
        <div id="first_line_page">
            ...
            <div class="wrapper-login">
                ...
                <form action="login/login_run" method="POST">
                    ...
                    <input type="text" placeholder="Username *" name="loginusername" id="login-username" value="<?php if (isset($_GET['uname'])) echo $uname; ?>" id="<?php echo isset($errors['username']) ? 'invalidFeedback' : ''  ?>">
