            ...
            <div class="wrapper-login">
                ...
                <form action="login/login_run" method="POST">
                    ...
                    <div class="register-box">
                        ...
                        <input type="text" placeholder="Username *" class="input register-input register-user-name" name="login-user-name" id="register-user-name" value="<?php if(isset($_GET['register_user_name'])){
