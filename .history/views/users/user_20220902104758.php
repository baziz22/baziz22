                ...
                ?>
                  <tr>
                    ...
                    <td class="action-btn"><?php if ($value['user_status'] == 1) {
                          echo '<button class="btn btn-status-inactive"><i class="fa-solid fa-power-off"></i> activated</button>';
                        } else {
                          echo '<a href="' . URLROOT . 'user/activate_user/' . $value['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-square-check"></i> activate</button></a>';
                        } ?></td>
