            ...
            <div class="dashboard-search-user">
              ...
              <div class="user-list-table">
                ...
                <div class="dashboard-table-header">
                  ...
                  <td class="action-btn"><?= (isset($_GET['user_status'])) ?? ($_GET['user_status'] == 1) ? '<button class="btn btn-status-inactive"><i class="fa-solid fa-trash-can"></i>activated</button>' : '<a href="' . URLROOT . 'user/activate_user/' . $users_basic_details['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a>' ;
                  ?></td>
