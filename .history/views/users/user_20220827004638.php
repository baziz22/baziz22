            ...
            <div class="user-list-table">
              <table>
                ...
                //foreach ($this->model->db->pagination($start_from, $per_page_record) as $key => $value) {
                  $paginate = new user();
                  $paginate->print_something();
                  /* for($i = 0; $i < $start_from; $i++){
                    //echo 'stage: ' . $i . '<br>';
                    echo $pages_number = $paginate->pagination($start_from, $per_page_record);
                  } */
                  print_r($paginate->all_records());
                  $pages_number = $paginate->pagination($start_from, $per_page_record);
                  echo ($pages_number).'<br>';
                  foreach ($paginate->all_records() as $key => $value) {
