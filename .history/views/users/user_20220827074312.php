      ...
      <section class="dashboard-container">
        ...
        <div class="dashboard-sidebar">
          ...
          <div class="btn dashboard-btn">
                    <?php if (Session::get('role') == 'owner') : ?>
                        <a href="messages">
                            <span class="material-symbols-outlined"> messages </span>
                        </a>
                    <?php endif; ?>
                </div>
          <div class="btn dashboard-btn">
              ...
              <table>
                ...
                //foreach ($this->model->db->pagination($start_from, $per_page_record) as $key => $value) {
                  ...
                  <tr>
                    ...
                    <td><?php if($value['user_status'] == 1){echo '<button class="btn btn-status-inactive"><i class="fa-solid fa-trash-can"></i>activated</button>';}else{echo '<a href="' . URLROOT . 'user/activate_user/' . $value['user_id'] .'"><button class="btn btn-status-activate"><i class="fa-solid fa-trash-can"></i>activate</button></a>';} ?></td>
