          ...
          <div class="dashboard-main-upper-middle">
            ...
            <div class="dashboard-statistics">
              ...
              <div class="dashboard-edit-user">
                ...
                //$edit_user_name = $users_basic_details[0];
                $edit_user_id = $users_basic_details['user_id'];
                echo 'the id is:: ' . $this->$users_basic_details[0['user_id'];
                $single_user = $userObj->single_user($id);
                print_r( $single_user);
                ?>
                <form action="../user/editSave/<?php echo $single_user['user_id']; ?>" method="POST">
                  ...
                  <select name="the_role" id="">
                    ...
                    <option value="user" <?php if ($single_user['user_role'] == 'user') echo 'selected'; ?>>User</option>
                    <option value="super" <?php if ($single_user['user_role'] == 'super') echo 'selected'; ?>>Super</option>
                    <option value="admin" <?php if ($single_user['user_role'] == 'admin') echo 'selected'; ?>>Admin</option>
