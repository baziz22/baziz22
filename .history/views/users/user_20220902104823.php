            ...
            <div class="dashboard-search-user">
              ...
              <div class="user-list-table">
                ...
                <div class="dashboard-table-header">
                  ...
                  <tr>
                  <td><?= (isset($_GET['user_name'])) ? $_GET['user_id'] : $single_user_record['user_name'] ?></td>
                  <td class="action-btn"><a href="#"><button class="btn btn-view"><i class="fa-solid fa-magnifying-glass"></i>View</button></a></td>
                  <td class="action-btn"><?= (isset($single_user_record['user_id'])) ?? ($single_user_record['user_status'] == 1) ? '<button class="btn btn-status-inactive"><i class="fa-solid fa-square-check"></i> activated</button>' : '<a href="' . URLROOT . 'user/activate_user/' . $single_user_record['user_id'] . '"><button class="btn btn-status-activate"><i class="fa-solid fa-power-off"></i> activate</button></a>' ;
                  ?></td>
                ...
                ?>
                  <tr>
                    ...
                    <td class="action-btn"><?php if ($value['user_status'] == 1) {
                          echo '<button class="btn btn-status-inactive"><i class="fa-solid fa-power-off"></i><i class="fa-solid fa-square-check"></i> activated</button>';
                        } else {
                          echo '<a href="' . URLROOT . 'user/activate_user/' . $value['user_id'] . '"><button class="btn btn-status-activate"> activate</button></a>';
                        } ?></td>
