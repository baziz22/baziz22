...
projects.forEach((project) => {
    ...
    btn.addEventListener('click', function(e) {
        ...
        display_project = document.querySelector(`#project-${project.name}`).style.display = "block";display_project = document.querySelector(`#project-${project.name}`).style.display = "block";
        });
