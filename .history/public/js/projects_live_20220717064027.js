...
function formateProjectName(name) {
 ...
 /* Live Modal */
    ...
    function runscript(project_live_btn) {
        ...
        show_hide(project_live_btn.id);
        console.log("e: ", show_hide(project_live_btn.id));
    ...
    function show_hide(project_name){
        let display_project = document.querySelector(`#project-${project_name}`);
        display_project.classList.togle('hide-project');
        display_project.classList.togle('show-project')
        if () {
            display_project.classList.remove('hide-project');
            display_project.classList.add('show-project');
        } else if (display_project.classList.contains('show-project')) {
