...
function validate() {
  ...
  if (full_nameValue === '') {
    ...
    //(contact_full_name.matches('.error')) ? console.log(true) : console.log(false);
  } else {
    // add success class
  ...
  let bader = setTimeout(checkme(), 2000);
  function checkme(){
    (setErrorFor) ? console.log(true) : console.log(false)
    //(contact_full_name.classList.contains('error')) ? console.log(true) : console.log(false)
  }
