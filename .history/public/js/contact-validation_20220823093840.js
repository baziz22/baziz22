...
function validate() {
  ...
  if (full_nameValue === '') {
    // show error
    // add error class
    setErrorFor(contact_full_name, 'Your Name is REQUIRED!');console.log(true) : console.log(false);
    (contact_full_name.matches('.error')) ? 
  } else {
    // add success class
  ...
  (!contact_full_name.classList.contains('.error')) ? true : false;
}
