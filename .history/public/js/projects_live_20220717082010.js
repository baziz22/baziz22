 ...
 /* Live Modal */
    ...
    span.addEventListener('click', function() {
        ...
        hide_content(this.id)
            const add_elements = () => {
                projects.forEach((project, i)=> {
                const el_tag = document.createElement("p")
                el_tag.setAttribute("id", `id="project-bar-chart"`);
                const el_text = document.createTextNode("This is new.")
                tag.appendChild(el_text);
