            ...
            const add_elements = () => {
                projects.forEach((project, i)=> {
                    if(project.name !== this.id){
                        ...
                        el2_tag.setAttribute("class"svg-container"", `views/includes/project_live/bar_chart/js/bar_chart.js`);
                        the_script.appendChild(el2_tag)


                        let the_script = document.querySelector(`#project-${project.name}`);
                        const el2_tag = document.createElement("script")
                        el2_tag.setAttribute("src", `views/includes/project_live/bar_chart/js/bar_chart.js`);
                        the_script.appendChild(el2_tag)
                    } else {
