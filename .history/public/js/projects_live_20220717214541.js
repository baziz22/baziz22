    ...
    function runscript(project_live_btn) {
        ...
        const remove_elements = () => {
            ...
            if(project.name == project_live_btn.id){
                ...
                the_script.innerHTML='<object type="text/javascript" data="./views/includes/project_live/bar_chart/bar_chart/js/bar_chart.js" ></object>';

                const el3_tag = document.createElement("script")
                el3_tag.setAttribute("src", "./views/includes/project_live/bar_chart/bar_chart.php");
