...
class User_Model extends Model{
    ...
    public function edit($data) {
      pre_r($data);
      if($_SESSION['user_name'] != $data['username']){
      
    }else{
      return "Sorry, this is not your username!";$sql = 'UPDATE users SET user_name = :username, user_email = :email, user_role = :the_role WHERE user_name = :username';
      $stmt = $this->db->connect()->prepare($sql);
      $stmt->execute(array(
