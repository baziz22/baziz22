...
class User_Model extends Model{
    ...
    public function userList() {
        $sql = "SELECT user_id, user_name, user_role, user_ FROM users";
    ...
    public function editSave($data) {
        pre_r($data);
        $sql = 'UPDATE users SET user_name = :username, user_password = :password, user_role = :the_role, user_status = :userstatus WHERE user_id = :id';
        $stmt = $this->db->connect()->prepare($sql);
        $stmt->execute(array(
            ':id' => $data['id'],
