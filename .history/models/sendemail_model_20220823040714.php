...
class Sendemail_Model extends Model{
    ...
    public function send_message($fields){
        ...
        echo "fields: " . BR;
        pre_r($fields);
        $sender_full_name = $field['full_name'];
        $sender_email = $field['contact_email'];
        $sender_subject = $field['contact_email'];
        $sender_message = $field['contact_email'];
         => Talal Baskran
    [contact_email] => taaalaaal@hotmail.com
